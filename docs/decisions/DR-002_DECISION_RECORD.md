...
| **Affects** | [`SCIENTIFIC_HYPOTHESIS.md`](../SCIENTIFIC_HYPOTHESIS.md) (H1 mechanism clause) · [`VESPER_PHASE1_VALIDATION.md`](../VESPER_PHASE1_VALIDATION.md) (keystone A6, Arm-B confirmation, period-FAP estimator, App A) · [`VESPER_MATHEMATICAL_FOUNDATIONS.md`](../VESPER_MATHEMATICAL_FOUNDATIONS.md) (§6 arbiter form, period-FAP estimator) → reissued as **VAL v3 / MATH v1.2** under a new pre-registration seal (**#2b**). |
