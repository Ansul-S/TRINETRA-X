...
Resume **VESPER**. Assume zero chat history; **repository documents are authoritative**, the vault mirrors them. Markdown docs are the deliverables (no GSD / `.planning/` in this repo).
